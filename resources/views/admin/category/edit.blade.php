...
<body>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                name='cate_name'  placeholder="请输入分类名称" value="{{$info->cate_name}}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                name='cate_show' value='1' {{($info->cate_show)==1?'checked':''}} >是
                <input type="radio"  id="lastname" 
                name='cate_show' value="2" {{($info->cate_show)==2?'checked':''}} >否
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                    <select name="parent_id" >
                         ...
                         <option value="{{$v->cate_id}}" {{($v->cate_id==$info->parent_id)?'selected':''}}>{{str_repeat('|—|',$v['lv']-1)}}{{$v->cate_name}}</option>
                         @endforeach
                    </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-danger">分类修改</button>
            </div>
        </div>
    </form>
</body>
